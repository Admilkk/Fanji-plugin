...
let Theme = {
  async getThemeCfg(theme, exclude) {
    let dirPath = './plugins/Fanji-plugin/resource/html/help/theme/';
    let ret = [];
    let names = [];
    ...
    let resPath = '{{_res_path}}/html/help/theme/';
    ...
    return {
      ...
      style: (await Data.importModule(`resource/html/help/theme/${name}/config.js`)).style || {},
    };
  },
